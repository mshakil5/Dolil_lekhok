...
<head>
  ...
  <body class="app sidebar-mini">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="{{ route('homepage')}}">Falcon</a>
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        @if(Auth::user()->is_type == 'admin' || in_array('3', json_decode(Auth::user()->staff->role->permissions)))
        <li><a class="app-menu__item" href="{{route('admin.client')}}" id="client"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Client</span></a></li>
        @endif

        @if(Auth::user()->is_type == 'admin' || in_array('3', json_decode(Auth::user()->staff->role->permissions)))
        <li><a class="app-menu__item" href="{{route('admin.buyer')}}" id="buyer"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Buyer</span></a></li>
        @endif

        @if(Auth::user()->is_type == 'admin' || in_array('3', json_decode(Auth::user()->staff->role->permissions)))
        <li><a class="app-menu__item" href="{{route('admin.landowner')}}" id="landowner"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Landowner</span></a></li>
        @endif
