                                    ...
                                    <table class="table table-bordered table-hover" id="example">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                              ...
                                              <td>
                                                <a href="{{ route('admin.land',$data->id)}}"><i class="fa fa-plus" style="color: #2196f3;font-size:16px;"></i></a>
...
@section('script')
    ...
    <script>
        $(document).ready(function () {
            ...
            var url = "{{URL::to('/admin/landowner')}}";
            // console.log(url);
